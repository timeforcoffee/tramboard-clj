...
(def station-base-url        (str "http://data.wemlin.com/rest/v0/networks/ostwind/stations/DI-0000{{id}}/"  (f/unparse wml/wml-formatter (t/now)) "/"  (f/unparse wml/wml-formatter (t/plus (t/now) (t/hours 2)))))
